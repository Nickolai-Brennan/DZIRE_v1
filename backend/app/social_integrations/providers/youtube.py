...
class YouTubeProvider(BaseProvider):
    ...
    async def schedule_post(self, post: Any, scheduled_at: Any) -> dict:
        ...
        logger.info(
            "[YouTube] schedule_post post_id=%s — mock", getattr(post, "id", None)
        )
    ...
    async def publish_post(self, post: Any) -> dict:
        ...
        logger.info(
            "[YouTube] publish_post post_id=%s — mock", getattr(post, "id", None)
        )
    ...
    async def fetch_metrics(self, post: Any) -> dict:
        ...
        logger.info(
            "[YouTube] fetch_metrics post_id=%s — mock", getattr(post, "id", None)
        )
    ...
    async def handle_webhook(self, payload: dict) -> dict:
        ...
        logger.info(
            "[YouTube] handle_webhook event=%s — mock", payload.get("event_type")
        )
