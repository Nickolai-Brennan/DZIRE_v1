...
class BlueskyProvider(BaseProvider):
    ...
    async def schedule_post(self, post: Any, scheduled_at: Any) -> dict:
        ...
        logger.info("[Bluesky] schedule_post post_id=%s — mock", getattr(post, "id", None))
    ...
    async def publish_post(self, post: Any) -> dict:
        ...
        logger.info("[Bluesky] publish_post post_id=%s — mock", getattr(post, "id", None))
    ...
    async def fetch_metrics(self, post: Any) -> dict:
        ...
        logger.info("[Bluesky] fetch_metrics post_id=%s — mock", getattr(post, "id", None))
    ...
    async def handle_webhook(self, payload: dict) -> dict:
        ...
        logger.info("[Bluesky] handle_webhook event=%s — mock", payload.get("event_type"))
