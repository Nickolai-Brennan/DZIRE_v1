...
class MastodonProvider(BaseProvider):
    ...
    async def schedule_post(self, post: Any, scheduled_at: Any) -> dict:
        ...
        logger.info("[Mastodon] schedule_post post_id=%s — mock", getattr(post, "id", None))
    ...
    async def publish_post(self, post: Any) -> dict:
        ...
        logger.info("[Mastodon] publish_post post_id=%s — mock", getattr(post, "id", None))
    ...
    async def fetch_metrics(self, post: Any) -> dict:
        ...
        logger.info("[Mastodon] fetch_metrics post_id=%s — mock", getattr(post, "id", None))
    ...
    async def handle_webhook(self, payload: dict) -> dict:
        ...
        logger.info("[Mastodon] handle_webhook event=%s — mock", payload.get("event_type"))
