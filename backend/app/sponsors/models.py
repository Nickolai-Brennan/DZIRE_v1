...
class Sponsor(Base):
    ...
    campaigns: Mapped[list["SponsorCampaign"]] = relationship("SponsorCampaign", back_populates="sponsor", lazy="select")
...
class SponsorCampaign(Base):
    ...
    sponsor: Mapped["Sponsor"] = relationship("Sponsor", back_populates="campaigns", lazy="joined")
