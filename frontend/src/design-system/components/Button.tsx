...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-primary hover:bg-accent text-white focus-visible:ring-primary/50',
  secondary:
  ...
  danger: 'bg-red-700 hover:bg-red-600 text-white focus-visible:ring-red-500/50',
  vip: 'bg-purple-700 hover:bg-purple-600 text-white focus-visible:ring-purple-500/50',
  sponsor: 'bg-yellow-500 hover:bg-yellow-400 text-black focus-visible:ring-yellow-400/50',
};
