...
export const ScorePill: React.FC<ScorePillProps> = ({ score, label, max = 10 }) => {
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border ${getColorClass()}`}>
