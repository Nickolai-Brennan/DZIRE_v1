...
const MOCK_CAMPAIGNS: Campaign[] = [
  { id: "1", name: "Summer 2025 Launch", status: "active", start_date: "2025-06-15", end_date: "2025-08-31", budget: 5000, spent: 1820 },
  { id: "2", name: "Influencer Collab Q3", status: "planning", start_date: "2025-07-01", end_date: "2025-09-30", budget: 12000, spent: 0 },
  { id: "3", name: "Back to School Promo", status: "planning", start_date: "2025-08-01", end_date: "2025-09-15", budget: 3500, spent: 0 },
  { id: "4", name: "Spring Collection", status: "completed", start_date: "2025-03-01", end_date: "2025-05-31", budget: 8000, spent: 7650 },
  { id: "5", name: "Valentine's Day Special", status: "completed", start_date: "2025-02-01", end_date: "2025-02-14", budget: 2000, spent: 1990 },
  { id: "6", name: "Holiday Gift Guide", status: "paused", start_date: "2025-11-01", end_date: "2025-12-31", budget: 6000, spent: 450 },
];
          ...
          <tbody className="divide-y divide-white/5">
            {campaigns.map((c) => (
              <tr key={c.id} className="hover:bg-white/3 transition-colors">
                <td className="py-3 pr-4 text-textPrimary font-medium">{c.name}</td>
