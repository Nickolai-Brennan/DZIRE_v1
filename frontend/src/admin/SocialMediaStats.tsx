...
const PLATFORMS = ['X / Twitter', 'Instagram', 'TikTok', 'YouTube', 'Reddit', 'Bluesky', 'Facebook', 'Threads'];
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {PLATFORMS.map((platform) => (
              <div key={platform} className="p-4 bg-surfaceAlt rounded-xl border border-white/10">
                ...
                <div className="flex items-center justify-between mt-1">
                  <span className="text-sm font-semibold text-textPrimary">—</span>
