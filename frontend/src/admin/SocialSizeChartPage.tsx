...
const SEED_DATA: SizeChartRow[] = [
  ...
  },
  {
    ...
    aspect_ratio: "9:16",
    safe_zone_notes:
      "Keep key content in center 1080x1420. Avoid top 250px (UI) and bottom 250px (swipe area).",
  ...
  },
  {
    id: "ig-5",
    platform: "Instagram",
    asset_type: "Profile Photo",
    recommended_width: 320,
    recommended_height: 320,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as 110px circle. Keep subject centered.",
    file_type: "JPG/PNG",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  },
  {
    id: "fb-3",
    platform: "Facebook",
    asset_type: "Cover Photo",
    recommended_width: 851,
    recommended_height: 315,
    aspect_ratio: "2.7:1",
    safe_zone_notes:
      "On mobile, cover is cropped to 640x360. Keep text in center-safe zone.",
    file_type: "JPG/PNG",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  },
  {
    ...
    recommended_height: 196,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Minimum 180x180 recommended.",
    file_type: "JPG/PNG",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  // X / Twitter
  {
    ...
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Keep subject well within frame.",
  ...
  },
  {
    ...
    aspect_ratio: "3:1",
    safe_zone_notes:
      "Profile photo overlaps bottom-left. Keep important content in center 1260x360.",
    file_type: "JPG/PNG/GIF",
    max_file_size: "5MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  // TikTok
  {
    ...
    hashtag_limit: 30,
    safe_zone_notes:
      "Keep text and key visuals in center 1080x1420. Avoid bottom 400px (UI overlay).",
    file_type: "MP4/MOV",
  ...
  },
  {
    ...
    aspect_ratio: "1:1",
    safe_zone_notes:
      "Minimum 20x20, recommended 200x200 for quality. Displayed as circle.",
    file_type: "JPG/PNG/GIF",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  // YouTube
  {
    ...
    aspect_ratio: "16:9",
    safe_zone_notes:
      "Minimum 640x360. Use high contrast and readable text at small sizes.",
  ...
  },
  {
    id: "yt-2",
    platform: "YouTube",
    asset_type: "Channel Banner",
    recommended_width: 2560,
    recommended_height: 1440,
    aspect_ratio: "16:9",
    safe_zone_notes:
      "Safe area for all devices: 1546x423 centered. TV displays the full 2560x1440.",
    file_type: "JPG/PNG",
    max_file_size: "6MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  },
  {
    ...
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Minimum 98x98.",
    file_type: "JPG/PNG/GIF/BMP",
    max_file_size: "2MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  },
  {
    id: "li-2",
    platform: "LinkedIn",
    asset_type: "Company Cover",
    recommended_width: 1128,
    recommended_height: 191,
    aspect_ratio: "5.9:1",
    file_type: "JPG/PNG",
    max_file_size: "4MB",
    last_verified_at: "2025-01-01",
  ...
  },
  {
    ...
    platform: "Pinterest",
    asset_type: "Profile",
    recommended_width: 165,
    recommended_height: 165,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Minimum 165x165.",
    file_type: "JPG/PNG",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  // Reddit
  {
    ...
    recommended_height: 256,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle.",
    file_type: "JPG/PNG",
    max_file_size: "1MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  // Threads
  {
    ...
    recommended_height: 320,
    aspect_ratio: "1:1",
    safe_zone_notes: "Synced with Instagram profile photo.",
    file_type: "JPG/PNG",
    last_verified_at: "2025-01-01",
    status: "active",
  },
  ...
  // Mastodon
  {
    ...
    recommended_height: 400,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as square with rounded corners.",
    file_type: "JPG/PNG/GIF",
    max_file_size: "2MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  // Discord
  {
    id: "dc-1",
    platform: "Discord",
    asset_type: "User Avatar",
    recommended_width: 256,
    recommended_height: 256,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Minimum 128x128 recommended.",
  ...
  },
  {
    id: "dc-2",
    platform: "Discord",
    asset_type: "Server Icon",
    recommended_width: 512,
    recommended_height: 512,
    aspect_ratio: "1:1",
    safe_zone_notes: "Displayed as circle. Minimum 512x512 for best quality.",
    file_type: "JPG/PNG/GIF/WebP",
    max_file_size: "8MB",
    last_verified_at: "2025-01-01",
    status: "active",
  ...
  },
  {
    id: "dc-4",
    platform: "Discord",
    asset_type: "Server Banner",
    recommended_width: 960,
    recommended_height: 540,
    aspect_ratio: "16:9",
    safe_zone_notes:
      "Requires Boost Level 2+. Animated GIF banners require Level 3.",
    file_type: "JPG/PNG/GIF",
    max_file_size: "10MB",
    last_verified_at: "2025-01-01",
    status: "active",
...
const ALL_PLATFORMS = [
  "All",
  ...Array.from(new Set(SEED_DATA.map((r) => r.platform))).sort(),
];
const ALL_ASSET_TYPES = (platform: string) => {
  const rows =
    platform === "All"
      ? SEED_DATA
      : SEED_DATA.filter((r) => r.platform === platform);
...
export const SocialSizeChartPage: React.FC = () => {
  ...
  const [editingRow, setEditingRow] = useState<SizeChartRow | null | undefined>(
    undefined,
  );
  const [copyMsg, setCopyMsg] = useState("");

  const assetTypes = useMemo(
    () => ALL_ASSET_TYPES(platformFilter),
    [platformFilter],
  );
  ...
  const filteredRows = useMemo(() => {
    return rows.filter((r) => {
      ...
      const matchAsset =
        assetTypeFilter === "All" || r.asset_type === assetTypeFilter;
