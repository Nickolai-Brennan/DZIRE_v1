...
export const PositionsPage: React.FC = () => {
  ...
  const [quickViewPosition, setQuickViewPosition] = useState<Position | null>(
    null,
  );
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-b from-surfaceAlt to-background py-16 px-4 sm:px-6 text-center mb-12">
        ...
        <p className="text-textMuted text-lg max-w-xl mx-auto mb-8">
          Comprehensive guides to intimate positions. Find what works for your
          comfort, energy, and connection.
        </p>
