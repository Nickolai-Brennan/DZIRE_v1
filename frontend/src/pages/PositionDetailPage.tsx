        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-surface rounded-2xl p-6 border border-white/8">
              ...
              <p className="text-textMuted leading-relaxed">
                This position offers a unique combination of intimacy and
                physical engagement, making it popular across experience levels.
                The natural body alignment creates comfort while enabling a
          ...
          <div className="space-y-6">
            ...
            <div className="bg-surfaceAlt rounded-2xl p-5 border border-white/8 text-center">
              <p className="text-sm font-bold text-textPrimary mb-3">
                Save this position
              </p>
              <SaveToPlaylistButton
                item={{
