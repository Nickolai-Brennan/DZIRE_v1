  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-b from-surfaceAlt to-background py-16 px-4 text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-black text-textPrimary mb-4">
          Get In Touch
        </h1>
        <p className="text-textMuted text-lg max-w-xl mx-auto">
          Questions, partnerships, editorial inquiries, or just want to say
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              {CONTACT_INFO.map((item) => (
                <div
                  key={item.label}
                  className="flex items-center gap-4 bg-surface rounded-xl p-4 border border-white/8"
                >
            ...
            <div className="bg-surface rounded-2xl p-6 border border-white/8">
              ...
              <p className="text-sm text-textMuted mb-4">
                Interested in becoming a DZIRE Doll or partnering with us? We'd
                love to feature your work.
              </p>
              <a
                href="mailto:creators@dzire.com"
