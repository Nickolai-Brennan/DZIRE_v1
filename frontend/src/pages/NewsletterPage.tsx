...
const NEWSLETTER_PERKS = [
  {
    ...
    desc: "Top positions, reviews, and stories delivered every week",
  },
  {
    icon: BookOpen,
    title: "Exclusive Content",
    desc: "Subscriber-only guides and tips not published on the site",
  },
  {
    icon: Star,
    title: "Early Access",
    desc: "Be first to know about new features, DZIRE Dolls, and updates",
  },
  {
    icon: Heart,
    title: "No Spam",
    desc: "We respect your inbox — one curated email per week, unsubscribe anytime",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-b from-primary/10 to-background py-20 px-4 text-center mb-12">
        ...
        <p className="text-textMuted text-lg max-w-xl mx-auto mb-8">
          Weekly insights on intimacy, desire, and connection. Join 10,000+
          readers.
        </p>
        {!submitted ? (
          ...
          <div className="bg-surface rounded-2xl p-8 max-w-md mx-auto border border-primary/30">
            ...
            <p className="text-textMuted text-sm">
              Check your inbox for a confirmation email. Your first DZIRE Letter
              arrives next Monday.
            </p>
          </div>
        )}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
          {NEWSLETTER_PERKS.map((perk) => (
            <div
              key={perk.title}
              className="flex gap-4 bg-surface rounded-2xl p-6 border border-white/8"
            >
        ...
        <div className="bg-surface rounded-2xl p-8 border border-white/8 text-center">
          ...
          <p className="text-textMuted text-sm mb-6">
            Get a feel for what we send before you subscribe.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              "Issue #003 · Beginner Guides",
              "Issue #002 · New Dolls Spotlight",
              "Issue #001 · Welcome to DZIRE",
            ].map((title) => (
              <div
                key={title}
                className="bg-surfaceAlt rounded-xl p-4 border border-white/8 text-left"
              >
